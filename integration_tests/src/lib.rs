...
use cksol_types_internal::{Ed25519KeyName, InitArgs, MinterArg, log::Priority};
...
impl CkSolMinter<'_> {
    ...
    pub async fn retrieve_sol(
        ...
        self.0
            .try_update_call("retrieve_sol", (args,))
            .await
    ...
    pub async fn retrieve_sol_status(&self, block_index: u64) -> RetrieveSolStatus {
        self.0
            .try_update_call("retrieve_sol_status", (block_index,))
            .await
