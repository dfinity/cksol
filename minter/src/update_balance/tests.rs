use crate::{
    ...
    test_fixtures::{
        deposit::{
            accepted_deposit_event, deposit_status_minted, deposit_status_processing, deposit_status_quarantined,
            deposit_transaction, deposit_transaction_signature, deposit_transaction_to_multiple_accounts,
            deposit_transaction_to_multiple_accounts_signature, deposit_transaction_to_wrong_address,
            deposit_transaction_to_wrong_address_signature,
            minted_event,
            quarantined_deposit_event, DEPOSITOR_ACCOUNT,
            DEPOSITOR_PRINCIPAL, DEPOSIT_AMOUNT,
        }, init_schnorr_master_key, init_state, init_state_with_args,
        runtime::TestCanisterRuntime,
        valid_init_args, EventsAssert, BLOCK_INDEX,
        DEPOSIT_FEE,
